import { AppBar, Fab, IconButton, InputAdornment, Stack, TextField, Toolbar, Typography } from '@mui/material'
  ...
  return (
    <AppBar position="fixed" sx={{ backgroundColor: 'white' }}>
      <Toolbar>
        ...
        <TextField onChange={(e) => props.setSearch(e.target.value)} size='small' sx={{ width: "50%", ml: 6, mr: 35 }} placeholder="Search" InputProps={{ endAdornment: (<InputAdornment position="end">   <SearchIcon /> </InputAdornment>) }} />
